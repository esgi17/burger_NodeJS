...
* @apiSuccess {Float} Burger.price Burger price
...
/**
 * @api {delete} /burger/:id Remove a Burger
 * @apiGroup burger
 * @apiParam {id} id Burger id
 * @apiSuccessExample
 *    HTTP/1.1 200 Burger deleted
 * @apiErrorExample
 *    HTTP/1.1 500 Internal Server Error
 * @apiErrorExample
 *    HTTP/1.1 403 Burger not found
 */
